        ...
        <section class="cd-hero">
          ...
          <div class="cd-slider-nav">
            <nav>
              ...
              <ul>
                ...
                <li><a href="#0"><div class="image-icon"><img src="img/projects-icon.png"></div><h6>Adopt Me</h6></a></li>
          ...
          <ul class="cd-hero-slider">
            ...
            <li class="selected">
              <div class="heading">
                <h1>PetPet!</h1>
                <span>Find your new best friend here<br>
                <h4><a href="/login">Login </a>| <a href="/registration">Register </a></h4></span>
              </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="content first-content">
                        <h4>About PetPet</h4>
                        <p>Our project main idea is to create a website for rescuing animals from cruelty and neglect (specially dogs & cats). This means shelters and rescues are full of loving, spayed or neutered, vaccinated, and often trained pets who are just waiting to meet you!  By adopting a cat or dog from a shelter or rescue, you can rest assured that you have not supported the puppy mill industry.
                        ...
                        <div class="primary-button">
                          <a href="youtube.com/watch?v=8ahLiNoBwxw">Discover More</a>
                        </div>
                      </div>
                    </div>
                  </div>                  
            ...
            <li>
              <div class="heading">
                <h1>About Us</h1>
                <span>Get More Info About PetPet <br> <h3>AMA Team</h3></span> 
              </div>
                      ...
                      <div class="content second-content">
                        <div class="row">
                          <div class="col-md-7 left-image">
                            <div><img src="img/left-about-image.jpg">
                          </div>
                          <div class="col-md-5">
                            <div class="right-about-text">
                            <!-- <div><img src="img/Moath.jpg"> -->

                              <h4>Who we are?</h4>
                              <p>We are three Engineers who care about pets! & taking their responsibility of protecting these beautiful creatures.
                                We are wading a new experience in Web development in <a href="#">AXSOS Acedemy</a> and trying to change our life as pet life.
                              </p>
                              <div class="primary-button">
                        ...
                        <div class="row">
                          <div class="col-md-7">
                            <div class="left-about-text">
                              <h4>What we do?</h4>
                              <p>AS part of our course requirments, we got this idea to create a website on JAVA language which the functuntionality of this website will be as a shelter and offering our services to take the pets, rescue them, clean them, treat them and finally search for a seautable and comfortable home to these pets.</p>
                              <div class="primary-button">
                                <a href="#">Discover More</a>
                              </div>
                            </div>
            ...
            <li>
              <div class="heading">
                <h1>PetPet Services</h1>
                <span>Helping others Changes Lives to Better</span> 
              </div>
            ...
            <li>
              <div class="heading">
                <h1>Adopt Me</h1>
                <span>Here you can find your new cute best friend</span> 
              </div>
              ...
              <div class="cd-half-width fivth-slide">
                <div class="container">
                  <div class="row">
                    ...
                    <div class="map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9925.859217194893!2d35.1636615984309!3d31.96041629596869!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzHCsDU3JzM3LjUiTiAzNcKwMTAnMDguMiJF!5e1!3m2!1sen!2sil!4v1622663511172!5m2!1sen!2sil" width="100%" height="390" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
                            <div class="left-info">
                              ...
                              <br><br>
                              <em>Axsos Academy - Intarnational Business School<br>Abu Shukhaydam - Ramallah - Palestine</em>
                              </p>
                              <ul class="social-icons">
                                <i><a href="#"><i class="fa fa-facebook"></i></a></i>
                                <i><a href="#"><i class="fa fa-instagram"></i></a></i>
                                <i><a href="#"><i class="fa fa-twitter"></i></a></i>
                                <i><a href="#"><i class="fa fa-google"></i></a></i>
